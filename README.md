...
- Results of hedge-ratio-based position sizing in the ETF-level simulation can be viewed on a per-model basis in each notebook in the models/training/ section
