...
def aggregate_results(X_train_dict, X_test_dict, y_test_dict, knn_models, scalers):
    results = {}
...
def simulate_portfolio(
    X_df, y_pred_label, prices_df, pair_betas, pair_name, probs,
...
def run_simulation(results, X_test_dict, testing_data, pair_betas, probs, initial_cash_per_pair = 100.0):
    ...
    plt.savefig("/Users/ak/Downloads/KNN_equity.pdf", dpi = 400, bbox_inches = "tight")
    plt.show()
